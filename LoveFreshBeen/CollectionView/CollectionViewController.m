...
- (void)viewDidLoad
{
    ...
    [[HttpManager sharedManager] getDataWithURLString:urlStr succeed:^(id response) {
        NSArray *categories = response[@"data"][@"categories"];
        [weakSelf setData:categories];
    }
...
- (UITableView *)tableView
{
    ...
    {
        _tableView =
            [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 80, SCREEN_HEIGHT)];
...
- (UICollectionView *)collectionView
{
    if (!_collectionView)
    {
        ...
        //注册分区头标题
        [self.collectionView registerClass:[CollectionHeader class]
                                 ...
                                 atIndexPath:(NSIndexPath *)indexPath
{
    ...
    CollectionHeader *view = [collectionView dequeueReusableSupplementaryViewOfKind:kind
